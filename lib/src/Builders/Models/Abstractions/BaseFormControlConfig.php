...
abstract class BaseFormControlConfig
{
     ...
     * @var array<string, string>
     */
    private array $jsErrorMessages = [];

    /**
     * @return string[]
     */
    public function getJsErrorMessages(): array
    {
        return $this->jsErrorMessages;
    }

    /**
     * @param  string[]  $jsErrorMessages
     * @return static
     */
    public function setJsErrorMessages(array $jsErrorMessages): static
    {
        $this->jsErrorMessages = $jsErrorMessages;
        return $this;
    }
    ...
    /**
     * @param  array<string>  $jsRules
     * @return static
     */
    public function setJsRules(array $jsRules): static
    {
