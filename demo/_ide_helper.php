...
')
     ...
     */ 
        ...
        {
                        /** @var \Zhelyazko777\LaravelSimpleMapper\SimpleMapper $instance */
     ...
     */ 
         ...
         * @param \Zhelyazko777\Forms\array<string,  mixed>  $args
         * @return \Zhelyazko777\Forms\Models\FormData 
         * @static 
         */ 
        public static function create($form, $model, $args = [])
        {
                        /** @var \Zhelyazko777\Forms\Form $instance */
                        return $instance->create($form, $model, $args);
        }
                    /**
         ...
         * @static 
         */ 
        public static function handle($form, $model, $request, $args = [])
        {
                        /** @var \Zhelyazko777\Forms\Form $instance */
                        return $instance->handle($form, $model, $request, $args);
        }
                    /**
         ...
         * @param \Illuminate\Database\Eloquent\Model $model
         * @param \Zhelyazko777\Forms\array<string,  mixed>  $args
         * @return \Zhelyazko777\Forms\array<string, mixed>
         * @static 
         */ 
        public static function getValidationRules($form, $model, $args = [])
        {
                        /** @var \Zhelyazko777\Forms\Form $instance */
                        return $instance->getValidationRules($form, $model, $args);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getSingleFieldValidationRules($fieldName, $form, $model, $args = [])
        {
                        /** @var \Zhelyazko777\Forms\Form $instance */
                        return $instance->getSingleFieldValidationRules($fieldName, $form, $model, $args);
        }
                    /**
         ...
         * @param \Illuminate\Database\Eloquent\Model $model
         * @param \Zhelyazko777\Forms\array<string,  mixed>  $args
         * @return \Zhelyazko777\Forms\array<string, string>
         * @static 
         */ 
        public static function getErrorMessages($form, $model, $args = [])
        {
                        /** @var \Zhelyazko777\Forms\Form $instance */
                        return $instance->getErrorMessages($form, $model, $args);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getSingleFieldErrorMessages($fieldName, $form, $model, $args = [])
        {
                        /** @var \Zhelyazko777\Forms\Form $instance */
                        return $instance->getSingleFieldErrorMessages($fieldName, $form, $model, $args);
        }
...
namespace  { 
            ...
            class Mapper extends \Zhelyazko777\LaravelSimpleMapper\SimpleMapperFacade {}
            class Form extends \Zhelyazko777\Forms\FormFacade {}
